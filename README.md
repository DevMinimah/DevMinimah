...
- Skills: Understanding distributed ledgers, cryptographic principles, and trustless architectures
- Connection: Blockchain's emphasis on immutability and audit trails directly informs my approach to security logging and incident response

### Web Development
- Stack: HTML, CSS, JavaScript, Python, MySQL, Dart/Flutter
- Experience: Building full-stack applications and understanding how systems are constructed
- Insight: Knowing how applications are built makes me better at identifying how they can be broken — and secured

### Cybersecurity (Current Focus)
- Specialization: Security operations, threat detection, incident response, and Linux/SQL-based investigations
- Approach: Combining my systems-thinking background with hands-on technical skills to protect digital infrastructure

---

## 🛡 Current Focus

Securing Systems Through Hands-On Learning:

- Google Cybersecurity Professional Certificate — Linux, SQL, SIEM, Threat Detection, Python for Security
- Microsoft SC-200 (Security Operations Analyst) — Defender XDR, Sentinel, KQL, Incident Response
- TS Academy Cybersecurity Program — Advanced SOC operations and threat hunting
- ISC2 Certified in Cybersecurity (CC) — Security principles, governance, and risk management
...
| Cybersecurity Program | TS Academy | 🔄 In Progress |
...
Security Operations: Linux (Bash, permissions, user management) | SQL (filtering, joins, KQL) | SIEM & Log Analysis | Threat Hunting | Incident Response | Python for Security

Development: Python | JavaScript | HTML/CSS | MySQL | Dart/Flutter | REST APIs
